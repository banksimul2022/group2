/********************************************************************************
** Form generated from reading UI file 'errorsivu.ui'
**
...
#ifndef UI_ERRORSIVU_H
#define UI_ERRORSIVU_H
...
public:
    ...
    {
        if (errorsivu->objectName().isEmpty())
            errorsivu->setObjectName(QString::fromUtf8("errorsivu"));
        ...
        QMetaObject::connectSlotsByName(errorsivu);
    } // setupUi

    void retranslateUi(QDialog *errorsivu)
    {
...
namespace Ui {
    class errorsivu: public Ui_errorsivu {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ERRORSIVU_H
